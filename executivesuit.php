   ...
   <div class="modal-content">
       ...
       if($totalnoofroomsitem5<6){
        ...
        echo '<div class="row">';
            ...
            echo '<div class="card" style="width: 18rem;">
              ...
              <a href="booknow.php?room_type=Executive suite" class="btn btn-sm btn-success">Book now</a>
              </div>
            </div>';
    ...
    <?php 
     ...
     <div class="modal-footer">
       <a href="executivesuit.php" type="button" class="btn btn-success btn-sm">Close</a>
     </div>
  </div>
 </div>
</div>';
...
<body>
   ...
   <div class="row">
        ...
        <form action="executivesuit.php" method="POST">   
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade show active" id="peter">
                        ...
                        <p class="text-justify">The executive rooms of the hotel have been designed exclusively for corporate travellers while they are equipped with additional facilities such as a rain head shower, lumbar supporting work desk chair, glass table, laptop and cell chargers at bed side etc. These bedrooms also offer access to the Executive Lounge together with a delicious complimentary American breakfast and happy hour cocktails in the evening and a range of service for the discerning traveller.</p>
                        <div class="row">
                            <div class="col-6">
