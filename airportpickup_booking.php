            ...
            <div class="col-6 offset-3">
                <div class="row mt-5">
                    ...
                    <lable><b>Your Name:</b></lable>
                                    <div class="row">
                                    <div class="col-6">
                                    <input type='text'name="first_name" class="form-control input-box form-rounded" value=<?php echo $fname;?> required>
                                    </div>
                                    <div class="col-6">
                                    <input type='text' name="last_name" class="form-control input-box form-rounded" value=<?php echo $lname;?> required>
                                    </div>
                                    </div>
                    </div>   
                </div>
