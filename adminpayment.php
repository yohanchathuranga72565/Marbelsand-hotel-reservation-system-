...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <?php 
                ...
                if(isset($_POST['search'])){
                    $filter=$_POST['filter'];
                    echo $filter;
                    $query0="SELECT payment_id FROM payment WHERE payment_id='{$filter}'";
                    ...
                    $query="SELECT * FROM payment WHERE payment_id='{$filter}' LIMIT {$start},{$rows_per_page}";
                    $query_run=mysqli_query($connection,$query);

                }
                else{
                    $query0="SELECT payment_id FROM payment";
                    $query_run0=mysqli_query($connection,$query0);
                    $total_rows=mysqli_num_rows($query_run0);
                    $rows_per_page=6;
                    ...
                    $query="SELECT * FROM payment LIMIT {$start},{$rows_per_page}";
                    $query_run=mysqli_query($connection,$query);
                }
            
            ?>
            <h2 class="text-center">About Payment Details</h2>
            <div class="text-right">
                ...
                <table class="table">
                    ...
                    <?php
                        ...
                        ?>
                    <tbody action="adminpayment.php" method="POST">
                        <tr>
        ...
        <?php 
        //first page
        $first="<a href=\"adminpayment.php?p=1\"><b>First</b></a>";

        //last page
        $last_page_no=ceil($total_rows/$rows_per_page);
        $last="<a href=\"adminpayment.php?p={$last_page_no}\"><b>Last</b></a>";
        ...
        if($page_no>=$last_page_no){
            ...
            $next="<a href=\"adminpayment.php?p={$next_page_no}\"><b>Next</b></a>";
        }
        ...
        if($page_no<=1){
            ...
            $prev="<a href=\"adminpayment.php?p={$prev_page_no}\"><b>Previous</b></a>";
        }
    ?>
    ...
    <div class="container">
        ...
        <?php if(!isset($_POST['search'])){?>
            ...
            <?php
                if(isset($_POST['search'])){
                    ?>
                    <a href="adminpayment.php" type="button" class="btn btn-success btn-sm">All payment</a>
                <?php
                }
            ?>
        </div>
