...
<body>
    ...
    <form method="post" action="https://sandbox.payhere.lk/pay/checkout"> 
        ...
        <input type="hidden" name="return_url" value="http://localhost/hotel reservation system/rooms.php">
        <input type="hidden" name="cancel_url" value="http://localhost/hotel reservation system/room_booking.php">
